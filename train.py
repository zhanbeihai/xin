...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = '/kaggle/input/weight/yolo_weights.pth'
    #------------------------------------------------------#
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '/kaggle/input/apple1/VOCdevkit/VOC2007/train.txt'
    val_annotation_path     = '/kaggle/input/apple1/VOCdevkit/VOC2007/val.txt'
